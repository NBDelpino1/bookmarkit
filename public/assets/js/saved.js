...
//MODAL MAYBE????
        var emptyAlert =
            $([
                ...
                '<p><span><i class="glyphicon glyphicon-chevron-up arrow-up-gliph"></i></span></p>',
                '<h4 class="no-note-msg">You dont have any saved articles right now</h4>',
    ...
    function handleArticleNotes(){
        ...
        $.get('/api/notes/' + currentArticle._id).then(function(data) {
            ...
            var modalText = [
                ...
                '<button class="btn btn-save-a-note save">Save Note</button>',
                '</div>'
            ].join("");
